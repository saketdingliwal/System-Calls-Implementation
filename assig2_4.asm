...
int main(int argc, char const *argv[])
{
   ...
   f:	83 ec 10             	sub    $0x10,%esp
	...
	float z;
	int pid = fork();
  12:	e8 a3 03 00 00       	call   3ba <fork>
	if(pid < 0)
  17:	85 c0                	test   %eax,%eax
  19:	0f 88 b9 00 00 00    	js     d8 <main+0xd8>
  1f:	bb 5a 00 00 00       	mov    $0x5a,%ebx
	{

	}
	else if(pid == 0)
  24:	0f 84 b3 00 00 00    	je     dd <main+0xdd>
  ...
  33:	68 53 08 00 00       	push   $0x853
  38:	6a 01                	push   $0x1
  3a:	e8 f1 04 00 00       	call   530 <printf>
			}
		}
	}
	else
  ...
  45:	75 e9                	jne    30 <main+0x30>
		...
		int pid1 = fork();
  47:	e8 6e 03 00 00       	call   3ba <fork>
		if(pid1 < 0)
  4c:	85 c0                	test   %eax,%eax
  4e:	0f 88 84 00 00 00    	js     d8 <main+0xd8>
  54:	d9 ee                	fldz   
  56:	d9 5d f0             	fstps  -0x10(%ebp)
		{

		}
		else if(pid1 == 0)
  59:	75 35                	jne    90 <main+0x90>
  5b:	e9 cc 00 00 00       	jmp    12c <main+0x12c>
  ...
  6a:	e8 c1 04 00 00       	call   530 <printf>
		...
		else
		{
			...
			for(z=0;z<900000;z=z+0.01){
  6f:	dd 05 70 08 00 00    	fldl   0x870
  75:	83 c4 10             	add    $0x10,%esp
  78:	d8 45 f0             	fadds  -0x10(%ebp)
  7b:	d9 5d f4             	fstps  -0xc(%ebp)
  7e:	d9 45 f4             	flds   -0xc(%ebp)
  81:	d9 55 f0             	fsts   -0x10(%ebp)
  84:	d9 05 78 08 00 00    	flds   0x878
  8a:	df e9                	fucomip %st(1),%st
  8c:	dd d8                	fstp   %st(0)
  8e:	76 3e                	jbe    ce <main+0xce>
				// printf(1, "process: %d has been scheduled priority: %d\n", getpid(), getpriority(getpid()));
				if(getpriority(getpid()) >= 10)
  90:	e8 ad 03 00 00       	call   442 <getpid>
  95:	83 ec 0c             	sub    $0xc,%esp
  98:	50                   	push   %eax
  99:	e8 e4 03 00 00       	call   482 <getpriority>
  9e:	83 c4 10             	add    $0x10,%esp
  a1:	83 f8 09             	cmp    $0x9,%eax
  a4:	7e ba                	jle    60 <main+0x60>
					printf(1, "pid: %d pr: %d\n", getpid(), getpriority(getpid()));
  a6:	e8 97 03 00 00       	call   442 <getpid>
  ab:	83 ec 0c             	sub    $0xc,%esp
  ae:	50                   	push   %eax
  af:	e8 ce 03 00 00       	call   482 <getpriority>
  b4:	89 c3                	mov    %eax,%ebx
  b6:	e8 87 03 00 00       	call   442 <getpid>
  bb:	53                   	push   %ebx
  bc:	50                   	push   %eax
  bd:	68 59 08 00 00       	push   $0x859
  c2:	6a 01                	push   $0x1
  c4:	e8 67 04 00 00       	call   530 <printf>
  c9:	83 c4 20             	add    $0x20,%esp
  cc:	eb 92                	jmp    60 <main+0x60>
				printf(1,"a\n");
				if(x==0){
					x=x;
				}
  ...
  ce:	e8 f7 02 00 00       	call   3ca <wait>
			wait();
  d3:	e8 f2 02 00 00       	call   3ca <wait>
		}
	}
	exit();
  d8:	e8 e5 02 00 00       	call   3c2 <exit>
  ...
  dd:	e8 60 03 00 00       	call   442 <getpid>
  e2:	51                   	push   %ecx
  e3:	51                   	push   %ecx
  e4:	6a 06                	push   $0x6
  e6:	50                   	push   %eax
  e7:	e8 8e 03 00 00       	call   47a <setpriority>
		for(z=0;z<900000;z=z+0.01){
  ec:	d9 ee                	fldz   
  ...
  fb:	d9 5d f0             	fstps  -0x10(%ebp)
  fe:	68 50 08 00 00       	push   $0x850
 103:	6a 01                	push   $0x1
 105:	e8 26 04 00 00       	call   530 <printf>
	}
	else if(pid == 0)
	{
		...
		setpriority(getpid(), 6);
		for(z=0;z<900000;z=z+0.01){
 10a:	dd 05 70 08 00 00    	fldl   0x870
 110:	83 c4 10             	add    $0x10,%esp
 113:	d9 45 f0             	flds   -0x10(%ebp)
 116:	de c1                	faddp  %st,%st(1)
 118:	d9 5d f4             	fstps  -0xc(%ebp)
 11b:	d9 45 f4             	flds   -0xc(%ebp)
 11e:	d9 05 78 08 00 00    	flds   0x878
 124:	df e9                	fucomip %st(1),%st
 126:	77 d0                	ja     f8 <main+0xf8>
 128:	dd d8                	fstp   %st(0)
 12a:	eb ac                	jmp    d8 <main+0xd8>
 ...
 133:	6a 06                	push   $0x6
 135:	50                   	push   %eax
 136:	e8 3f 03 00 00       	call   47a <setpriority>
			for(z=0;z<900000;z=z+0.01){
 13b:	d9 ee                	fldz   
 ...
 143:	d9 5d f0             	fstps  -0x10(%ebp)
 146:	68 56 08 00 00       	push   $0x856
 14b:	6a 01                	push   $0x1
 14d:	e8 de 03 00 00       	call   530 <printf>
		...
		else if(pid1 == 0)
		{
			...
			setpriority(getpid(), 6);
			for(z=0;z<900000;z=z+0.01){
 152:	dd 05 70 08 00 00    	fldl   0x870
 158:	83 c4 10             	add    $0x10,%esp
 15b:	d9 45 f0             	flds   -0x10(%ebp)
 15e:	de c1                	faddp  %st,%st(1)
 160:	d9 5d f4             	fstps  -0xc(%ebp)
 163:	d9 45 f4             	flds   -0xc(%ebp)
 166:	d9 05 78 08 00 00    	flds   0x878
 16c:	df e9                	fucomip %st(1),%st
 16e:	77 d0                	ja     140 <main+0x140>
 170:	dd d8                	fstp   %st(0)
 172:	e9 61 ff ff ff       	jmp    d8 <main+0xd8>
...
putc(int fd, char c)
{
 ...
 648:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 64b:	b8 7c 08 00 00       	mov    $0x87c,%eax
...
free(void *ap)
{
 ...
 727:	89 08                	mov    %ecx,(%eax)
  freep = p;
 729:	a3 20 0b 00 00       	mov    %eax,0xb20
}
 72e:	5b                   	pop    %ebx
 72f:	5e                   	pop    %esi
 730:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 15 20 0b 00 00    	mov    0xb20,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7bf:	76 3f                	jbe    800 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	39 05 20 0b 00 00    	cmp    %eax,0xb20
 ...
 7e6:	e8 e5 fe ff ff       	call   6d0 <free>
  return freep;
 7eb:	8b 15 20 0b 00 00    	mov    0xb20,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 80c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 80f:	89 15 20 0b 00 00    	mov    %edx,0xb20
      return (void*)(p + 1);
 ...
 824:	eb e9                	jmp    80f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 826:	c7 05 20 0b 00 00 24 	movl   $0xb24,0xb20
 82d:	0b 00 00 
 830:	c7 05 24 0b 00 00 24 	movl   $0xb24,0xb24
 837:	0b 00 00 
    base.s.size = 0;
 83a:	b8 24 0b 00 00       	mov    $0xb24,%eax
 83f:	c7 05 28 0b 00 00 00 	movl   $0x0,0xb28
 846:	00 00 00 
