...
int main(int argc , char *argv[]){
  ...
  19:	78 71                	js     8c <main+0x8c>
  1b:	bb 5a 00 00 00       	mov    $0x5a,%ebx
	{

	}
	else if(pid == 0)
  20:	74 6f                	je     91 <main+0x91>
  ...
  3d:	75 e9                	jne    28 <main+0x28>
		...
		int pid1 = fork();
  3f:	e8 26 03 00 00       	call   36a <fork>
		if(pid1 < 0)
  44:	85 c0                	test   %eax,%eax
  46:	78 44                	js     8c <main+0x8c>
  48:	d9 ee                	fldz   
		{

		}
		else if(pid1 == 0)
  4a:	0f 84 8c 00 00 00    	je     dc <main+0xdc>
		}
		else
		{
  ...
  53:	d9 5d f0             	fstps  -0x10(%ebp)
  56:	68 03 08 00 00       	push   $0x803
  5b:	6a 01                	push   $0x1
  5d:	e8 7e 04 00 00       	call   4e0 <printf>
		...
		{
			for(z=0;z<900000;z=z+0.01){
  62:	dd 05 10 08 00 00    	fldl   0x810
  68:	83 c4 10             	add    $0x10,%esp
  6b:	d9 45 f0             	flds   -0x10(%ebp)
  6e:	de c1                	faddp  %st,%st(1)
  70:	d9 5d f4             	fstps  -0xc(%ebp)
  73:	d9 45 f4             	flds   -0xc(%ebp)
  76:	d9 05 18 08 00 00    	flds   0x818
  7c:	df e9                	fucomip %st(1),%st
  7e:	77 d0                	ja     50 <main+0x50>
  80:	dd d8                	fstp   %st(0)
				printf(1,"a\n");
				if(x==0){
					x=x;
			...
			wait();
  82:	e8 f3 02 00 00       	call   37a <wait>
			wait();
  87:	e8 ee 02 00 00       	call   37a <wait>
		}
	}
exit();
  8c:	e8 e1 02 00 00       	call   372 <exit>
  ...
  91:	e8 5c 03 00 00       	call   3f2 <getpid>
  96:	51                   	push   %ecx
  97:	51                   	push   %ecx
  98:	6a 12                	push   $0x12
  9a:	50                   	push   %eax
  9b:	e8 8a 03 00 00       	call   42a <setpriority>
		for(z=0;z<900000;z=z+0.01){
  a0:	d9 ee                	fldz   
  ...
  ab:	d9 5d f0             	fstps  -0x10(%ebp)
  ae:	68 00 08 00 00       	push   $0x800
  b3:	6a 01                	push   $0x1
  b5:	e8 26 04 00 00       	call   4e0 <printf>
	...
	else if(pid == 0)
	{
		...
		setpriority(getpid(), 18);
		for(z=0;z<900000;z=z+0.01){
  ba:	dd 05 10 08 00 00    	fldl   0x810
  c0:	83 c4 10             	add    $0x10,%esp
  c3:	d9 45 f0             	flds   -0x10(%ebp)
  c6:	de c1                	faddp  %st,%st(1)
  c8:	d9 5d f4             	fstps  -0xc(%ebp)
  cb:	d9 45 f4             	flds   -0xc(%ebp)
  ce:	d9 05 18 08 00 00    	flds   0x818
  d4:	df e9                	fucomip %st(1),%st
  d6:	77 d0                	ja     a8 <main+0xa8>
  d8:	dd d8                	fstp   %st(0)
  da:	eb b0                	jmp    8c <main+0x8c>
  dc:	d9 5d f0             	fstps  -0x10(%ebp)
		{
  ...
  e6:	6a 13                	push   $0x13
  e8:	50                   	push   %eax
  e9:	e8 3c 03 00 00       	call   42a <setpriority>
			for(z=0;z<900000;z=z+0.01){
  ee:	d9 45 f0             	flds   -0x10(%ebp)
		{
...
putc(int fd, char c)
{
 ...
 5f8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5fb:	b8 1c 08 00 00       	mov    $0x81c,%eax
...
malloc(uint nbytes)
{
 ...
 76f:	76 3f                	jbe    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	39 05 c0 0a 00 00    	cmp    %eax,0xac0
 ...
 796:	e8 e5 fe ff ff       	call   680 <free>
  return freep;
 79b:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7bc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7bf:	89 15 c0 0a 00 00    	mov    %edx,0xac0
      return (void*)(p + 1);
 ...
 7d4:	eb e9                	jmp    7bf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7d6:	c7 05 c0 0a 00 00 c4 	movl   $0xac4,0xac0
 7dd:	0a 00 00 
 7e0:	c7 05 c4 0a 00 00 c4 	movl   $0xac4,0xac4
 7e7:	0a 00 00 
    base.s.size = 0;
 7ea:	b8 c4 0a 00 00       	mov    $0xac4,%eax
 7ef:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 7f6:	00 00 00 
